<h2 style="text-align:center">Food Delivery App Android Studio Java </h2>
  ...
  The food delivery app android studio java frontend source code for our solution is completely open source. However, the API and backend is proprietary and can be accessed via a paid license. For more details, <a href="https://onboarding.enatega.com/register/?utm_source=github&utm_medium=repo&utm_campaign=gray-food-delivery-app-android-studio-java" target="_blank">click here</a>.